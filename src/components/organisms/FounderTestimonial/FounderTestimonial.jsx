                        ...
                        {testimonials.map((testimonial, index) => (
                            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 animate-slide-up">
                                <div className="flex items-center gap-4 mb-4">
                                    <div>
                                        <Avatar src={testimonial.avatar} alt={testimonial.name} size={110} className='mt-[-35px]' />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl font-bold text-gray-800">{testimonial.name}</h3>
                                        <div className="flex gap-2 mt-2">
                                            <Badge text={testimonial.role} />
                                            <Badge text={testimonial.company} color="bg-orange-500" />
                                        </div>
                                    </div>
                                </div>
