...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#F7F8FA] shadow-sm sticky z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <SecondaryButton className="text-2xl" link="/login">
              Login
            </SecondaryButton>
            <PrimaryButton className="text-2xl" link="/register">
              Sign Up
            </PrimaryButton>
          </div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 space-y-2">
              <SecondaryButton className="mr-3">Login</SecondaryButton>
