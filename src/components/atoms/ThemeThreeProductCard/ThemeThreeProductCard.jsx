        ...
        <div className="group relative bg-gradient-to-br from-white to-gray-50 rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="relative p-5">
                ...
                <button
                    ...
                    className="absolute top-6 right-6 z-20 backdrop-blur-md bg-white/30 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:bg-white"
                >
                    {isWishlisted ? (
                ...
                <div className="absolute top-6 left-6 z-20">
                    <span
                        className={`px-4 py-2 rounded-full text-sm font-medium tracking-wide shadow-lg backdrop-blur-md transition-transform duration-300 group-hover:scale-105 ${
                            product.inStock 
