...
const ThemeFiveProductCard = ({ product }) => {
  ...
  return (
    <div className="group bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold text-neutral-dark truncate">{name}</h3>
        ...
        <button 
          ...
          className="mt-4 w-full bg-primary text-white py-2 rounded-md flex items-center justify-center gap-2 transition-all duration-300 hover:bg-primary/90 group"
        >
